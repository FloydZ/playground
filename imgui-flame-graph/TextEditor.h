...
public:
	...
	using LineOverlayCallback = std::function<void(int lineNumber, const ImVec2& lineStart)>;
	void SetLineOverlayCallback(LineOverlayCallback cb) {
	    mLineOverlayCallback = cb;
	}
...
private:
	...
	LineOverlayCallback mLineOverlayCallback = nullptr;
};
