...
from ckks.util.ciphertext import Ciphertext
import ckks.util.matrix_operations
from ckks.util.polynomial import Polynomial
from ckks.util.random_sample import sample_triangle
...
class CKKSBootstrappingContext:
    ...
    def generate_encoding_matrices(self):
        ...
        self.encoding_mat_transpose0 = ckks.util.matrix_operations.transpose_matrix(self.encoding_mat0)
        self.encoding_mat_conj_transpose0 = ckks.util.matrix_operations.conjugate_matrix(
            self.encoding_mat_transpose0)
        self.encoding_mat_transpose1 = ckks.util.matrix_operations.transpose_matrix(self.encoding_mat1)
        self.encoding_mat_conj_transpose1 = ckks.util.matrix_operations.conjugate_matrix(
